...
class RestrictedWordApiClient {
    ...
    private static mapFromApi(serverObject: RestrictedWordDto): RestrictedWordViewModel {
        return {
            ...
            deletedAt: serverObject.deleted_at ? moment(serverObject.deleted_at).format("DD MMM YY") : "-",
    ...
    public async patchSuperRestrictedStatus(
        options: RestrictedWordPatchSuperRestrictedRequest,
    ...
    public async createRestrictedWord(
        word: string,
        createdReason: string,
        categories: Array<string>,
        superRestricted: boolean,
        deleteConflicting: boolean
    ) {
        try {
